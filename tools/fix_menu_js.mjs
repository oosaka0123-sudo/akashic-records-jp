...
const marker="const explorer=document.querySelector('[data-memory-explorer]');";
const rest=s.slice(s.indexOf(marker));
const head=`const button=document.querySelector('.menu-button');
...
`;
fs.writeFileSync(p,head+rest,'utf8');
